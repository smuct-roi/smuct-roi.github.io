---
# Display name
title: Víctor Gutiérrez-Basulto
weight: 70
...
- icon: globe
  icon_pack: fas
  link: https://profiles.cardiff.ac.uk/staff/gutierrezbasultov
# - icon: envelope
#   icon_pack: fas
#   link: 'mailto:AlvaManchegoF@cardiff.ac.uk'
- icon: twitter
  icon_pack: fab
  link: https://twitter.com/vicgtzbasulto
- icon: google-scholar  # Alternatively, use `google-scholar` icon from `ai` icon pack
  icon_pack: ai
  link: https://scholar.google.co.uk/citations?user=L2eFo5IAAAAJ&hl=en
