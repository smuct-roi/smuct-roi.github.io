...
- icon: google-scholar  # Alternatively, use `google-scholar` icon from `ai` icon pack
  icon_pack: ai
  link: https://scholar.google.com/citations?hl=en&user=jnindL8AAAAJ
# - icon: semantic-scholar
#   icon_pack: ai
#   link: https://www.semanticscholar.org/author/Fernando-Alva-Manchego/69930782
- icon: github
  icon_pack: fab
  link: https://github.com/Nourollah
- icon: linkedin
  icon_pack: fab
  link: https://www.linkedin.com/in/amnrl/
