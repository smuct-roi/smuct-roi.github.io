...
- icon: globe
  icon_pack: fas
  link: https://zarasiddique.com/
# - icon: envelope
#   icon_pack: fas
#   link: 'mailto:AlvaManchegoF@cardiff.ac.uk'
- icon: twitter
  icon_pack: fab
  link: https://twitter.com/TheZaraSiddique
...
- icon: github
  icon_pack: fab
  link: https://github.com/groovychoons
- icon: linkedin
  icon_pack: fab
  link: https://www.linkedin.com/in/zarasiddique/
